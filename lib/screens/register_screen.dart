...
import 'package:muzzbirzha_mobile/models/http_models/reg_request.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void registerUser() async {
    ...
    var regResponse = await _muzzClient.registerUser(regRequest);
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SignInButton(caption: "Want be in!", onTap: signUserUp),
                const SizedBox(height: 25),
                const Padding(
